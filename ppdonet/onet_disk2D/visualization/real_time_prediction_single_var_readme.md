...
The predicted image represents the quasi-steady-state surface density distribution of the disk-planet system with the disk-planet parameters on the left. The surface density is normalized by the initial surface density profile.
