...
try:
    from fargo_model import (  # noqa: F401
        FargoFNOConfig,
        ThetaSpectralRadialConv,
        make_fargo_fno,
        make_time_conditioned_fno,
        pad_radial,
        time_conditioned_grid_inputs,
    )
except ModuleNotFoundError:  # pragma: no cover - keeps minimal FNO imports usable.
    pass
